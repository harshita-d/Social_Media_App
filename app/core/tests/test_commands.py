...
class CommandTests(SimpleTestCase):
    ...
    def test_wait_for_db_ready(self, patched_check):
        ...
        # In this case, we can execute our application, and no need to do anything. # noqa
        """
        patched_check.return_value = True  # noqa
        # The above line indicates that when the `check` method of the wait_for_db command is called during the test execution, it will return True. # noqa
